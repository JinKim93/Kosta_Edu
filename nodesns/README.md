...
### 38. 해시태그기능 구현(routes하위 post.js)
- 해시태그 라우처추가(routes하위 page.js)

![image](https://user-images.githubusercontent.com/82345970/177475512-40edebd8-8c79-4bb5-9a2f-99069fa38df7.png)

![image](https://user-images.githubusercontent.com/82345970/177475579-f6425ef1-9725-430b-a4c8-38742cf8f9cb.png)

### 38. 해시태그기능적용소스코드(routes하위 post.js)
```js
const express = require("express");
const multer = require("multer");
const path = require("path");
...
### 38. 해시태그검색기능 구현
- routes 하위폴더 page.js /hashtag 라우터 추가

![image](https://user-images.githubusercontent.com/82345970/177478244-d071a7e3-064f-46e9-a59a-94833bcace8c.png)

### 38. 해시태그검색기능 구현소스코드(page.js)
```js
const express = require('express');
...
### 38. 꿀팁
- // GET /hashtag?hashtag=노드, 노드 같은 한글검색할때는 문제가 될수 있음

- views하위 main.html 부분보면 form은 encodeURIComponet가 자동으로 됨

![image](https://user-images.githubusercontent.com/82345970/177476715-7dc70a6c-ae7e-4794-ba10-9dacbbb7d9f7.png)

- 하지만 axios로 데이터를 보내는대, 주소에 한글을 쓰고 싶을경우

![image](https://user-images.githubusercontent.com/82345970/177476894-55915d6e-f813-44e7-b22d-631a7b6c3502.png)

- 하기 사진처럼 바꿔주면 됨(main.js -> 프론트)
- 또한 서버쪽에서도 변경해줘야함(routes폴더하위 page.js)

![image](https://user-images.githubusercontent.com/82345970/177477188-3ec08dc2-f45a-4aa6-9931-4417dd734ab3.png)

![image](https://user-images.githubusercontent.com/82345970/177477366-3232365f-0477-4424-81fb-b67c7132de7f.png)
